...
{
    Log::create_stream(mms::LOG_NAMELIST, [$columns = NameListRecord, $ev = log_mms_name_list, $path="mms_name_list", $max_field_string_bytes=mms::default_max_field_string_bytes]);
}
